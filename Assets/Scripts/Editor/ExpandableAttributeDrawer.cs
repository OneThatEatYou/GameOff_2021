// script source: https://forum.unity.com/threads/editor-tool-better-scriptableobject-inspector-editing.484393/
...
public class ExpandableAttributeDrawer : PropertyDrawer
{
    ...
    /// </summary>
    private static Color LIGHTEN_COLOUR = new Color(1.0f, 1.0f, 1.0f, 0.05f);
    #endregion
